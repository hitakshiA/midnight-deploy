...
class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      initialize: (...args_1) => {
        ...
        const initialAdminPk_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('initialize',
                                      'argument 1 (as invoked from Typescript)',
                                      'Passport.compact line 6 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        if (!(initialAdminPk_0.buffer instanceof ArrayBuffer && initialAdminPk_0.BYTES_PER_ELEMENT === 1 && initialAdminPk_0.length === 32)) {
          __compactRuntime.type_error('initialize',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(initialAdminPk_0),
    ...
    this.impureCircuits = { initialize: this.circuits.initialize };
  }
  initialState(...args_0) {
    if (args_0.length !== 1) {
  ...
  _initialize_0(context, partialProofData, initialAdminPk_0) {
                    ...
                    [
                     { push: { storage: false,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_4.toValue(0n),
                                                                            alignment: _descriptor_4.alignment() }).encode() } },
                     { push: { storage: true,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(initialAdminPk_0),
                                                                            alignment: _descriptor_1.alignment() }).encode() } },
                     { ins: { cached: false, n: 1 } }]);
    Contract._query(context,
                    partialProofData,
